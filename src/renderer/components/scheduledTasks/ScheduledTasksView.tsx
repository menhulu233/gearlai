        ...
        <div className="flex items-center space-x-3 h-8">
          {isSidebarCollapsed && (
            <div className={`non-draggable flex items-center gap-1 ${isMac ? 'pl-[68px]' : ''}`}>
              <button
                ...
                className="h-8 w-8 inline-flex items-center justify-center rounded-lg dark:text-secondary text-secondary hover:bg-surface-raised transition-colors"
              >
          ...
          {viewMode !== 'list' && (
            <button
              ...
              className="non-draggable p-2 rounded-lg hover:bg-surface-raised dark:text-secondary text-secondary transition-colors"
              aria-label={i18nService.t('back')}
            >
              <ArrowLeftIcon className="h-5 w-5" />
            </button>
          )}
          <h1 className="text-lg font-semibold dark:text-foreground text-foreground">
        ...
        <div className="flex items-center justify-between border-b border-border px-4 shrink-0">
            ...
            <button
              ...
              className={`px-4 py-2.5 text-sm font-medium transition-colors relative ${
                activeTab === 'tasks'
                  ...
                  : 'dark:text-secondary text-secondary hover:dark:text-foreground hover:text-foreground'
              }`}
            >
          ...
          {activeTab === 'tasks' && (
            <button
              ...
              className="px-3 py-1 text-sm font-medium bg-primary text-white rounded-lg hover:bg-primaryHover transition-colors"
            >
