  ...
  return (
    <div className="w-full animate-fade-in-up">
      ...
      <div className="mb-2.5 px-0.5">
        <span className="text-xs font-medium dark:text-secondary text-secondary">
          {action.label}
        </span>
      </div>
              ...
              className={`
                ...
                ${
                  isPromptSelected
                    ...
                    : 'dark:bg-surface bg-surface border-border hover:border-border hover:bg-surface-raised'
                }
              `}
            >
              {/* 标题 */}
              <div className="flex items-center justify-between w-full">
                <span className={`text-sm font-medium ${isPromptSelected ? 'text-primary' : 'dark:text-foreground text-foreground'}`}>
                  {prompt.label}
                </span>
                <ArrowRightIcon
                  className={`
                    ...
                    ${
                      isPromptSelected
                        ...
                        : 'dark:text-secondary text-secondary -translate-x-1 opacity-0 group-hover:translate-x-0 group-hover:opacity-100'
                    }
                  `}
                />
              </div>
              ...
              {/* 描述 */}
              {prompt.description && (
                <p className="text-xs dark:text-secondary text-secondary line-clamp-2">
                  {prompt.description}
                </p>
              )}
            </button>
