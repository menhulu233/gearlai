...
const SkillsPopover: React.FC<SkillsPopoverProps> = ({
  ...
  return (
    <div
      ref={popoverRef}
      className="absolute bottom-full left-0 mb-2 w-72 rounded-xl border border-border dark:bg-surface bg-surface shadow-xl z-50"
    >
      {/* Search input */}
      <div className="p-3 border-b border-border">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 text-sm rounded-lg dark:bg-surface bg-surface text-foreground placeholder-secondary border border-border focus:outline-none focus:ring-2 focus:ring-primary"
          />
        </div>
      </div>
