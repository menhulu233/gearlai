  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-3">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 text-sm rounded-xl dark:bg-surface bg-surface text-foreground placeholder-secondary border border-border focus:outline-none focus:ring-2 focus:ring-primary"
          />
        </div>
        <div className="relative">
          <button
            ...
            className="px-3 py-2 text-sm rounded-xl border transition-colors dark:bg-surface bg-surface border-border text-foreground hover:bg-surface-raised flex items-center gap-2"
          >
          ...
          {isAddSkillMenuOpen && (
            <div
              ref={addSkillMenuRef}
              className="absolute right-0 mt-2 w-72 rounded-xl border border-border dark:bg-surface bg-surface shadow-lg z-50 overflow-hidden"
            >
              <button
                type="button"
      ...
      <div className="grid grid-cols-2 gap-3">
        {filteredSkills.length === 0 ? (
          ...
          filteredSkills.map((skill) => (
            <div
              key={skill.id}
              className="rounded-xl border border-border dark:bg-surface/50 bg-surface/50 p-3 transition-colors hover:border-primary/50 cursor-pointer"
              onClick={() => setSelectedSkill(skill)}
            >
              <div className="flex items-start justify-between mb-2">
                <div className="flex items-center gap-2 min-w-0">
                  <div className="w-7 h-7 rounded-lg dark:bg-surface bg-surface flex items-center justify-center flex-shrink-0">
                ...
                <button
                  ...
                  className={`px-2.5 py-1 text-xs rounded-lg transition-colors ${
                    activeMarketTag === 'all'
                      ...
                      : 'dark:bg-surface bg-surface text-secondary hover:bg-surface-raised border border-border'
                  }`}
                >
      ...
      {selectedMarketplaceSkill && createPortal(
        ...
        >
          <div
            className="w-full max-w-md mx-4 rounded-2xl dark:bg-surface bg-surface border border-border shadow-2xl p-6"
            onClick={(event) => event.stopPropagation()}
          >
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center gap-3 min-w-0">
                <div className="w-9 h-9 rounded-lg dark:bg-background bg-background flex items-center justify-center flex-shrink-0">
      ...
      {skillPendingDelete && createPortal(
        ...
        >
          <div
            className="w-full max-w-sm mx-4 rounded-2xl dark:bg-surface bg-surface border border-border shadow-2xl p-5"
            onClick={(event) => event.stopPropagation()}
          >
          ...
          >
            ...
            <div className="mt-5 space-y-3">
              ...
              <input
                ...
                className="w-full px-3 py-2.5 text-sm rounded-xl dark:bg-background bg-background text-foreground placeholder-secondary border border-border focus:outline-none focus:ring-2 focus:ring-primary"
              />
