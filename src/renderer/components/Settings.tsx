      ...
      case 'general':
        return (
          <div className="space-y-8">
            ...
            {/* Appearance Section */}
            <div>
              <h4 className="text-sm font-medium mb-3" style={{ color: 'var(--gearl-text-primary)' }}>
                ...
                {themeService.getAllThemes().map((t) => {
                  ...
                  return (
                    <button
                      ...
                      style={{
                        borderColor: isSelected ? 'var(--gearl-primary)' : undefined,
                        backgroundColor: isSelected ? 'var(--gearl-primary-muted)' : undefined,
                      }}
                    >
                      ...
                      <span className="text-[10px] font-medium truncate w-full text-center" style={{ color: isSelected ? 'var(--gearl-primary)' : 'var(--gearl-text-primary)' }}>
                        {t.meta.name}
                      </span>
                    </button>
                  );
