...
const CoworkSearchModal: React.FC<CoworkSearchModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className="modal-content w-full max-w-2xl mt-10 rounded-2xl border border-border dark:bg-surface bg-surface shadow-modal overflow-hidden"
        role="dialog"
        aria-modal="true"
        ...
        <div className="flex items-center gap-3 px-4 py-3 border-b border-border">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 text-sm rounded-lg dark:bg-surface bg-surface text-foreground placeholder:text-secondary border border-border focus:outline-none focus:ring-2 focus:ring-primary"
            />
          </div>
          <button
            type="button"
