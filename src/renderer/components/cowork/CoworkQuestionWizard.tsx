...
const CoworkQuestionWizard: React.FC<CoworkQuestionWizardProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center modal-backdrop">
      <div className="modal-content w-full max-w-2xl mx-4 dark:bg-surface bg-surface rounded-2xl shadow-modal overflow-hidden">
        {/* Header */}
          ...
          <div className="flex-1">
            ...
            <div className="mt-4 flex items-center gap-3">
              <input
                ...
                className="flex-1 px-3 py-2 rounded-lg border border-border dark:bg-background bg-background text-foreground placeholder:text-secondary focus:outline-none focus:ring-2 focus:ring-primary/50 text-sm"
              />
              <button
                type="button"
                onClick={handleSkip}
        ...
        <div className="flex items-center justify-end px-6 py-4 border-t border-border bg-surface-raised">
          <button
            ...
            className="px-5 py-2 text-sm font-medium rounded-lg bg-primary hover:bg-primaryHover text-white transition-colors"
          >
