...
const CoworkView: React.FC<CoworkViewProps> = ({ onRequestAppSettings, onShowSkills, isSidebarCollapsed, onToggleSidebar, onNewChat, updateBadge }) => {
  ...
  if (!isInitialized) {
    return (
      <div className="flex-1 h-full flex flex-col dark:bg-background bg-background">
  ...
  return (
    <div className="flex-1 flex flex-col dark:bg-background bg-background h-full">
      {/* Header */}
      ...
      <div className="flex-1 overflow-y-auto min-h-0">
        <div className="max-w-3xl mx-auto px-4 py-16 space-y-12">
          ...
          <div className="text-center space-y-5">
            ...
            <h2 className="text-3xl font-bold tracking-tight dark:text-foreground text-foreground">
              {i18nService.t('coworkWelcome')}
            </h2>
            <p className="text-sm dark:text-secondary text-secondary max-w-md mx-auto">
          ...
          <div className="space-y-3">
            <div className="shadow-glow-primary rounded-2xl">
              <CoworkPromptInput
                ref={promptInputRef}
