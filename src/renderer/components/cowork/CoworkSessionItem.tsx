  ...
  return (
    ...
    >
          ...
          <div className={`flex items-center mb-1 ${showStatusIndicator ? 'gap-2' : 'gap-0'}`}>
            ...
            {isRenaming ? (
              <input
                ...
                className="flex-1 min-w-0 rounded-lg border border-border dark:bg-background bg-background px-2 py-1 text-sm font-medium text-foreground focus:outline-none focus:ring-2 focus:ring-primary"
              />
            ) : (
      ...
      {menuPosition && (
        <div
          ref={menuRef}
          className="fixed z-50 min-w-[180px] rounded-xl border border-border dark:bg-surface bg-surface shadow-lg overflow-hidden"
      ...
      {showConfirmDelete && (
        ...
        >
          <div
            className="w-full max-w-sm mx-4 dark:bg-surface bg-surface rounded-2xl shadow-xl overflow-hidden"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Header */}
            ...
            <div className="flex items-center justify-end gap-3 px-5 py-4 border-t border-border">
              <button
                onClick={handleCancelDelete}
                className="px-4 py-2 text-sm font-medium rounded-lg text-secondary dark:hover:bg-surface-raised hover:bg-surface-raised transition-colors"
              >
