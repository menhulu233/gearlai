          ...
          {filteredInstalled.length === 0 ? (
            ...
            filteredInstalled.map((server) => {
              ...
              return (
                <div
                  key={server.id}
                  className="rounded-xl border border-border dark:bg-surface/50 bg-surface/50 p-3 transition-colors hover:border-primary/50"
                >
                  ...
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <div className="flex items-center gap-1.5 flex-shrink-0">
                      {installedRegistryIds.has(entry.id) ? (
                        <span className="px-2.5 py-1 text-xs rounded-lg bg-surface dark:bg-surface text-secondary">
                          {i18nService.t('mcpInstalled')}
                        </span>
                      ) : (
                        <button
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <button
              ...
              className="rounded-xl border-2 border-dashed border-border text-secondary hover:border-primary hover:text-primary transition-colors flex items-center justify-center min-h-[120px] text-sm"
            >
