...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    coworkWorkingDirectoryHint: 'GearlAI 将在此目录下执行命令',
    coworkSystemPrompt: '系统提示词',
    coworkSystemPromptPlaceholder: '为 GearlAI 设置自定义指令...',
    coworkSystemPromptHint: '可选的系统提示词，用于自定义 GearlAI 的行为',
    coworkModelSettingsRequired: '请先在模型设置中配置可用模型与 API Key。',
    coworkModelSettingsTitle: '模型设置',
    coworkModelSettingsHint: 'GearlAI 使用模型设置中的当前模型与提供商配置。',
    ...
    coworkPermissionDescription: 'GearlAI 请求执行以下操作',
    coworkToolName: '工具名称',
  ...
  en: {
    ...
    coworkSettings: 'GearlAI Settings',
    ...
    coworkWorkingDirectoryHint: 'GearlAI will execute commands in this directory',
    coworkSystemPrompt: 'System Prompt',
    coworkSystemPromptPlaceholder: 'Set custom instructions for GearlAI...',
    coworkSystemPromptHint: 'Optional system prompt to customize GearlAI\'s behavior',
    ...
    coworkModelSettingsHint: 'GearlAI uses the current model and provider configuration from Model Settings.',
    ...
    coworkPermissionDescription: 'GearlAI is requesting to perform the following action',
    ...
    imConnectivityCheckTitle_nim_p2p_only_hint: 'NIM P2P Mode',
    ...
    nimAccountHint: 'IM account ID (accid) created in NIM console account management',
    nimCredentialsGuide: 'How to obtain NIM credentials:',
    nimGuideStep1: 'Log in to NIM console (yunxin.163.com)',
    ...
    nimAppKeyHint: 'Obtain from app information in NIM console',
    ...
    scheduledTasksFormNotifyTelegram: 'Telegram',
    scheduledTasksFormNotifyDiscord: 'Discord',
    scheduledTasksFormNotifyNim: 'NIM',
