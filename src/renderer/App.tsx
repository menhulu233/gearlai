...
const App: React.FC = () => {
  ...
  if (!isInitialized) {
    return (
      <div className="h-screen overflow-hidden flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center dark:bg-background bg-background">
  ...
  if (initError) {
    return (
      <div className="h-screen overflow-hidden flex flex-col">
        {windowsStandaloneTitleBar}
        <div className="flex-1 flex flex-col items-center justify-center dark:bg-background bg-background">
    ...
    <div className="h-screen overflow-hidden flex flex-col bg-surface-raised">
      ...
      <div className="flex flex-1 min-h-0 overflow-hidden">
        ...
        <div className={`flex-1 min-w-0 py-1.5 pr-1.5 ${isSidebarCollapsed ? 'pl-1.5' : ''}`}>
          <div className="h-full min-h-0 rounded-xl dark:bg-background bg-background overflow-hidden">
            {mainView === 'skills' ? (
              <SkillsView
