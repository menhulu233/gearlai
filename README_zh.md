...
```bash
# 克隆仓库
git clone https://github.com/menhulu233/gearlai.git
cd gearlai
...
[![Star History Chart](https://api.star-history.com/svg?repos=menhulu233/gearlai&type=date&legend=top-left)](https://www.star-history.com/#menhulu233/gearlai&type=date&legend=top-left)
