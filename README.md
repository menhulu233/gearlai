...
**gearl-cowork-pure** 是 [GearlAI](https://github.com/menhulu233/gearlai) 的桌面端分支，专注于维护其核心功能 —— **Cowork 模式**。
...
```bash
# 克隆仓库
git clone https://github.com/menhulu233/gearl-cowork-pure.git
cd gearl-cowork-pure
...
gearl-cowork-pure 采用 Electron 严格进程隔离架构，所有跨进程通信通过 IPC 完成。
