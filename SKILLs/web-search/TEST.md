...
This guide walks through testing the entire Web Search Skill integration with GearlAI.

## Prerequisites

1. GearlAI built and ready to run
2. Google Chrome installed
3. Internet connection available

## Test 1: Service Auto-Start

**Objective:** Verify that the Bridge Server starts automatically with GearlAI.

**Steps:**

1. Start GearlAI in development mode:
   ```bash
...
**Expected Result:** ✅ Bridge Server starts automatically within 3 seconds of GearlAI launch.
...
1. Open a terminal while GearlAI is running
...
**Objective:** Verify graceful shutdown of services when GearlAI quits.

**Steps:**

1. With GearlAI running and searches completed, quit the application
...
1. Start GearlAI (ensure headless is false in config)
...
- ✅ Server auto-starts with GearlAI
